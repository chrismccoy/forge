...
> **Scope note:** For generating a COMPLETE plugin from scratch as a full
> WordPress.org-ready directory tree, defer to the `wordpress-plugin` skill. Use
> the structures below as reference when **extending an existing plugin** or
> adding a targeted component - not as a trigger to scaffold a whole plugin here.
